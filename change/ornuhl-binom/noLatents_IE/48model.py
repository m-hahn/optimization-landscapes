...
fit = sm.sampling(data=dat, iter=2000, chains=4, control=dict(adapt_delta=0.95))
print("TREE DEPTH", pystan.stan_utility.check_treedepth(fit))
print("E-BFMI", pystan.stan_utility.check_energy(fit))
