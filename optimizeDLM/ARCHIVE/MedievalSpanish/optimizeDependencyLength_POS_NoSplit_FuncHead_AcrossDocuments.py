...
relevantPath = "/u/scr/mhahn/deps/DLM_MEMORY_OPTIMIZED/locality_optimized_dlm/manual_output_funchead_fine_depl_funchead_ISWOC_Spanish/"
...
while True:
  ...
  for current in corpus:
       ...
       if counter % 10000 == 0:
          ...
          print "Saving"
          with open(TARGET_DIR+"/manual_output_funchead_fine_depl_funchead_ISWOC_Spanish/"+args.language+"_"+__file__+"_model_"+str(myID)+".tsv", #"w") as outFile:
