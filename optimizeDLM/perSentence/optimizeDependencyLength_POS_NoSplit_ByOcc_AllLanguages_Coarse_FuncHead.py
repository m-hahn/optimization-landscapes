...
relevantPath = "/u/scr/mhahn/deps/DLM_MEMORY_OPTIMIZED/locality_optimized_dlm/manual_output_funchead_fine_depl_perSent_perOcc_coarse_funchead/"

while len(languages) > 0:
   script = 'optimizeDependencyLength_POS_NoSplit_ByOcc_Coarse_FuncHead.py'
...
#   if negCount >= 8 and posCount >= 8:
   ...
   subprocess.call(['/u/nlp/anaconda/ubuntu_16/envs/py27-mhahn/bin/python2.7', script, "--language="+language,  "--entropy_weight=0.00", "--lr_policy="+LR_POLICY, "--momentum=0.9"])
