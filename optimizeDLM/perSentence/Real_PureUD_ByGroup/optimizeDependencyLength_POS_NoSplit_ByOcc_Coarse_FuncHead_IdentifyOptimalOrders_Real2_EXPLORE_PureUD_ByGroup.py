...
#         print(subjectItem)
         ...
         subjectItem = subjectItem[0]
         verbObject = batchOrdered[subjectItem["reordered_head"]-1]
         objectItems = [y for y in batchOrdered if y["reordered_head"] == subjectItem["reordered_head"] and y["dep"].startswith("obj")]




         realOrderType = detectOrder(subjectItem, verbObject, objectItems)
         realOrder = (1 if subjectItem["index"] < subjectItem["head"] else -1)
