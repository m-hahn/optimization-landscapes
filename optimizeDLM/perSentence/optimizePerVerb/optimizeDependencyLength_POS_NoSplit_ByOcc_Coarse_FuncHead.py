...
while True:
  ...
  for sentence in corpus:
       ...
       if counter % 10000 == 0:
          ...
          print "Saving"
          with open(TARGET_DIR+"/manual_output_funchead_fine_depl_perSent_perOcc_coarse_funchead/"+args.language+"_"+__file__+"_model_"+str(myID)+".tsv", "w") as outFile:
             ...
             for i in range(len(itos_deps)):
                ...
                print >> outFile, "\t".join(map(str,[round(dhWeight, 2), rel, round(distanceWeight, 2), args.language, myID]))
