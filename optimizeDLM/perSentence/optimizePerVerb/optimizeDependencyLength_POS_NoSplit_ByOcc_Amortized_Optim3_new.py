...
parser.add_argument('--lr_grammar', type=float, default=random.choice([0.00002, 0.0001, 0.001, 0.01]))
parser.add_argument('--momentum_grammar', type=float, default=random.choice([0.0, 0.2, 0.8, 0.9]))
parser.add_argument('--lr_amortized', type=float, default=random.choice([0.000001, 0.00001, 0.00002, 0.0001, 0.001]))
