...
group = "DLM_MEMORY_OPTIMIZED/locality_optimized_dlm/manual_output_funchead_fine_depl_TuebaJS"
   ...
   if "model" in filename:
      ...
      with open(PATH+filename, "r") as inFile:
          ...
          for line in inFile:
             ...
             if entry["CoarseDependency"] not in ["sbj", "comp"] or entry["HeadPOS"] != "V":
                  continue
             print(entry)
