...
group = "DLM_MEMORY_OPTIMIZED/locality_optimized_dlm/manual_output_funchead_fine_depl_PTB"
   ...
   if "model" in filename:
      ...
      with open(PATH+filename, "r") as inFile:
          ...
          for line in inFile:
             ...
             if entry["CoarseDependency"] not in ["nsubj", "obj"]:
                continue
             if "HeadPOS" in entry and (entry["HeadPOS"] != "VERB" or entry["DependentPOS"] != "NOUN"):
                continue
             print(entry)
