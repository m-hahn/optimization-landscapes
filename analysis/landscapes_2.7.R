...
data = read.csv("manual_output_funchead_fine_depl_auto-summary-lstm_2.7.tsv", sep="\t")
dataBackup = data
...
real = read.csv("mle-fine_selected_auto-summary-lstm_2.7.tsv", sep="\t")
...
write.table(u, file="landscapes_2.7_new.R.tsv")
write.table(real, file="landscapes_2.7_new_real.R.tsv")
write.table(data, file="landscapes_2.7_new_data.R.tsv")
