...
data = read.csv("manual_output_funchead_fine_depl_nopos_auto-summary-lstm_2.8.tsv", sep="\t")
dataBackup = data
...
write.table(u, file="landscapes_noPOS_2.8_new.R.tsv")
write.table(real, file="landscapes_noPOS_2.8_new_real.R.tsv")
write.table(data, file="landscapes_noPOS_2.8_new_data.R.tsv")
