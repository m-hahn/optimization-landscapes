...
data = read.csv(paste(DEPS, "LANDSCAPE/manual_output_funchead_parser_fine_2.6", "/", "auto-summary-lstm_2.6.tsv", sep=""), sep="\t")
dataBackup = data
...
library(lme4)
sink("output/landscapes_2.6_FuncHead_Pars.R.txt")
...
capture.output(summary(model), file="output/landscapes_2.6_FuncHead_Pars.R_brms.txt")
...
ggsave("figures/fracion-optimized_DLM_2.6_FuncHead_Pars.pdf", height=13, width=13)
