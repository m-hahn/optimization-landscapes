...
ggsave("figures/objects-order-pureud-byVerb.pdf", width=10, height=10)
...
ggsave("figures/objects-order-families-pureud-byVerb.pdf")
...
plot = plot + geom_point(alpha=0.2) + xlab("Fraction of SOV/VSO/OSV... Orders (Real)") + ylab("Objects Fraction") + xlim(0,1) 
...
ggsave("figures/objects-order-historical-pureud-byVerb.pdf")
