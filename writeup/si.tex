...
\begin{align*}
	...
	\operatorname{d}(\xi_2)_{L,t} &= \Gamma_{22} \cdot ((\xi_2)_{L,t}-\mu_2) \operatorname{d}t + \textcolor{blue}{\Gamma_{12} \cdot ((\xi_1)_{L,t}-\mu_1) \operatorname{d}t} + \Lambda_{22} \operatorname{d}B_t \\
\end{align*}
...
We adopt the word order grammar formalism of \cite{gildea-optimizing-2007,gildea-grammars-2010,gildea-human-2015} adapted to Universal Dependencies.


The original grammar formlism of \cite{gildea-optimizing-2007} was defined for constituency treebanks; it defined weights for each combination of parent and child constituent category (e.g., ``NP$\rightarrow$JJ'' for the position of the adjective within the noun phrase).
...
\textcolor{red}{TODO maybe make a figure}
...
This extension makes the average dependency length a \emph{differentiable} function of the grammar parameters.
...
Over the course of optimization, the probabilistic grammars converge to deterministic ones that minimize average dependency length across the trees in the corpus.
