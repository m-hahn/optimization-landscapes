...
In the main paper, we reported the correlation between the two dimensions in the stationary distribution $\Omega$.
...
This confirms that coadaptation is found even when explicitly modeling convergence between neibhboring languages.


\begin{figure}
    \includegraphics[width=0.5\textwidth]{../change/ornuhl-binom-geo-time/fits/corr_sigma.pdf}
	\caption{Posterior of the correlation component of $\Sigma$ (see Section~\ref{sec:instant-corr}) when accounting for areal convergemce.}\label{fig:posterior-area-time}
\end{figure}
