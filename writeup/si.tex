...
\begin{longtable}{lllll}
Language & Sentences & Words \\ \hline
\include{optimizeDLM/SpokenJapanese/corpora}
\include{optimizeDLM/UD_Spoken/corpora}
\include{optimizeDLM/Switchboard/corpora}
\end{longtable}
...
%\include{../collectPerVerbProperties/SV_withinLang/results_analyze_VSOrderWhenNoObject.R.tex}
\end{longtable}
