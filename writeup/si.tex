...
Here, we describe how we annotated categorical basic word order for languages in our dataset without annotation in \citet{wals-81}.
We primarily drew on \citep{gell-mann-origin-2011}, supplemented with language-specific literature.
