...
We also find evidence for a relation between order and co-expression within individual languages.
In many SVO languages, intransitive subjects can appear after the verb (``along came a dog'' CITE, see Si Section X).
...
The theory of coadaptation adds to existing efficiency-based accounts of language by highlighting that individual aspects do not evolve towards efficiency in isolation; rather, we argue that language as a whole evolves to maintain efficiency.
We expect that coadaptation may play a role in other aspects of language.
...
In many SVO languages, certain intransitive subjects can appear after the verb (``along came a dog'' CITE, see Si Section X).
...
- UD corpus evidence:
-- among languages, the rate of VS tends to be higher when no object is present than when an object is present


VSProb $\sim$ ObjPresent
...
-- among languages, the rate of VS tends to be higher in embedded clauses than in unembedded clauses
