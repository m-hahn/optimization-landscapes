...
\textcolor{blue}{A possible concern is that some langyage families are represented more than others; in particular, 46 of the languages belong to the Indo-European phylum.
The correlation between optimized and attested subject-object position congruence was also significant when excluding the Indo-European languages (\textcolor{red}{TODO}).
