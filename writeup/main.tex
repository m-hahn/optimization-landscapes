...
About 40\% of the world's languages are classified as having subject-verb-object order (\key{SVO}, as in English, a dog bites a human), and 40 \% are classified as having subject-object-verb order (\key{SOV}, dog-human-bites) (CITE).
...
\key{Coadaptation} between grammar and usage.
...
A prominent formalization of this idea is \key{Dependency Length Minimization}, the observation that languages tend to order words in such a way as to reduce the overall distance between syntactically related words \citep{rijkhoff-word-1986,hawkins-performance-1994,futrell-cross-linguistic-2015, liu-dependency-2017}.
...
We quantify the position of an individual language on this continuum using a quantitative corpus-based metric which we call \key{Subject-Object Symmetry}.
