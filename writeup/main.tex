...
We represent such optimal orderings using the  established model of counterfactural order grammar introduced by \cite{gildea-optimizing-2007}.
...
\begin{figure*}
%    \centering
    \includegraphics[width=0.25\textwidth]{../change/visualize/stationary.pdf}
