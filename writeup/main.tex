...
Drawing on phylogenetic modelling and historical text corpora from seven language families, we show that historical word order change is accompanied by change the distribution of propositions that speakers communicate.
