...
In our sample of historical trajectories, movement coincides with the loss of case marking in two cases (English and Romance).
However, we found that, when applied to the entire dataset, the model continued to predict co-evolution between usage and word order even when controlling for the presence or absence of case (see SI Section XX).
...
The conditional distribtion is given by \citep[Theorem 3.3]{schach1971weak}, \citep{gardiner1983handbook}, \citep[p. 156, eq. 6.124]{risken1989fokker}
...
\end{equation}
The stationary covariance between the states of two languages $L_1, L_2$ is given by
\begin{equation}
...
In some cases, this annotation was unambiguous due to available historical documentation even though no treebank data was availavble (e.g., Proto-West-Scandinavian was a late form of Old Norse had case markers, Global Dutch had no case markers).
...
We plot the posterior of the correlation component of $\Sigma$ in Figure X.
