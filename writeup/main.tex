...
\begin{figure}
    \centering
    \includegraphics[width=0.3\textwidth]{figures/fracion-optimized_DLM_2.6.pdf}
...
%We obtained phylogenetic trees for the languages in our dataset (see Materials and Methods for details).
%We modified these trees by adding historical stages of existing languages for which we have corpora, such as Old English (approx. 900 AD) as an ancestor of English.
