...
\begin{figure}
    ...
    \caption{Study 1: Subject-object symmetry and real (x-axis) and approximately optimized (y-axis) orderings.}
    \label{fig:study1}
\end{figure}
...
Data from related languages may permit inferences about their (undocumented) common ancestor, and thus about possible trajectories of historical change \citep{dunn-evolved-2011, maurits2014tracing}.


We used a model of random walks on phylogenetic trees \citep{felsenstein1973maximum,pagel1997inferring} to model how grammar and usage of a language evolve over time, and to test the Coadaptation Hypothesis.
...
As the components of $\xi_{L,t}$ are continuous, we model their change over time using a random walk given by an Ornstein-Uhlenbeck process (\citep{sy1997a, blackwell2003bayesian}, see Materials and Methods for details).
