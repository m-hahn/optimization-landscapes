...
\subsection*{\textcolor{blue}{Relation between Usage and Word Order}}
...
Optimized grammars are created using the gradient descent method described by \citep{hahn2020universals} \textcolor{blue}{(see SI Section S14 for more on this)}.
