...
%
We propose an account that explains the fine-grained distribution of word order patterns across languages in terms of coadaptation between usage and grammar:
%
%We report evidence for an additional functional pressure in the evolution of word order across languages: C.
...
\cite{ferrer-i-cancho-placement-2017} suggest that SOV and SVO are optimal under different efficiency criteria, but does not provide an account predicting word order on the level of individual languages. 
...
%There is no reason to believe that SOV and SVO languages are not equally efficient \citep{newmeyer2000evolutionary}
In contrast, the theory of coadaptation explicitly accounts for the language-dependence of word order.
