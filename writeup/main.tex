...
Our proposal of coadaptation suggests that languages have the basic word orders that are most efficient for DLM, given the ways speakers of a language typically structure information\textcolor{blue}{, and, conversely, that speakers structure information in ways efficient for DLM.}
