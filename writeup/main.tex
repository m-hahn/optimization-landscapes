...
\begin{figure*}[h!]
    \centering
	\begin{tabular}{cc}
		(A) All Languages & (B) Excluding Indo-European \\
...
%    \includegraphics[width=0.32\textwidth]{../change/visualize/stationary.pdf}
 %   \includegraphics[width=0.65\textwidth]{../analysis/figures/historical_2.6_times_stationary_layout.pdf}
	...
	\caption{
	\mhahn{i'm unsure about the colors, and whether there is anything else to improve this visualization.}
...
\textcolor{blue}{Specifically, we labeled each languages in our dataset, including the inner nodes of the phylogenetic tree, for four discrete word order categories (``SVO'', ``SOV'', and rarer categories ``VSO'', ``No dominant order''). Annotations were based on typological databases for documented languages \cite{wals-81}, and on reconstructions \cite{gell-mann-origin-2011} for undocumented ancestors (see SI  Appendix, Section S6 for details).}
...
\textcolor{blue}{Our results do not speak to the causal direction of changes in individual languages. Our currently available data are consistent with causal influence in either direction with the possibility of a third hidden causal factor (see SI Section X for analyses).
